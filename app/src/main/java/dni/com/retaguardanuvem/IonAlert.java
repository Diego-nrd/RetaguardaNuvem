...
public class IonAlert extends AlertDialog implements View.OnClickListener {
    ...
    private ImageView mErrorX, mSuccessTick, mCustomImage, mWarningTick;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWarningTick = findViewById(R.id.warning_x);
    ...
    private void playAnimation() {
        ...
        if(mAlertType == WARNING_TYPE){
            mWarningTick.startAnimation(mImageAnim);
        }
    }
        ...
        if (mDialogView != null) {
            ...
            switch (mAlertType) {
                ...
                case WARNING_TYPE:
                    ...
                    mCancelButton.setBackgroundColor(getContext().getResources().getColor(R.color.color_red2));
                    mCancelButton.setTextColor(getContext().getResources().getColor(R.color.color_white));
                    mConfirmButton.setBackgroundColor(getContext().getResources().getColor(R.color.color_green2));
                    break;
